...
from palaver_shared.audio_events import AudioEvent, AudioEventListener, AudioErrorEvent

class AudioListener(Protocol):

    def add_audio_event_listener(self, e_listener: AudioEventListener) -> None: ...

    async def set_in_speech(self, value) -> None: ...
