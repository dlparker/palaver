#!/usr/bin/env python3
"""
palaver/recorder/vad_recorder_v2.py
Phase 1 – Multiprocess Transcription Version (December 2025)

Features:
- Concurrent transcription via worker processes
- Bounded queue to manage memory
- Incremental + final transcript output
- Extensible for remote LLM backends
"""
...
class ResultCollector:
    ...
    def __init__(self, session_dir: Path, result_queue: Queue):
...
def main():
    ...
    collector = ResultCollector(session_dir, result_queue)
    collector.start()
