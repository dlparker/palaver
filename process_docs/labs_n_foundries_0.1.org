...
* LabsNFoundaries: An software development process

** Main goals a spectrum

In the beginning, the main goal is mostly or even exclusively creating
clear understanding of the problem space and the application of specific
techniques to solve those problems.

At the end, the goal is almost exclusively creating reliable, maintainable
